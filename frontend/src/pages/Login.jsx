...
export default function LoginPage() {
  return (
    ...
    >
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(255,255,255,0.18),_transparent_28%),radial-gradient(circle_at_bottom_right,_rgba(255,255,255,0.12),_transparent_25%)]" />

      <div className="absolute -top-24 -left-24 h-80 w-80 rounded-full bg-white/8 blur-3xl" />
      <div className="absolute -bottom-20 -right-20 h-[28rem] w-[28rem] rounded-full bg-emerald-300/10 blur-3xl" />
